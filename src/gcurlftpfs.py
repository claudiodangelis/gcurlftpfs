...
class about:
  def __init__(self,root):
    ...
    Label(self.main_about,text="Original author: Claudio Dawson d\'Angelis (claudiodangelis@gmail.com)\n\nhttp://www.claudiodangelis.com/projects/gcurlftpfs\n\n").grid()  
...
def fatal_error(err):
  ...
  print 'INFO: http://wwww.claudiodangelis.com/projects/gcurlftpfs'
